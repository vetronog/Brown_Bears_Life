...
### Шаги по сборке
1. Выбрать платформу для сборки
2. Cкачать необходимые SDK (IOS или Android)
3. Запустить билд (File/BuildSettings)

### Шаги по запуску тестов
1. Нажимаем Window → Unit Test Runner и смотрим.

### Шаги по выкладыванию
1. При начале работы над фичей, создать ветку features/new_brunch_name
2. При окончании работы над фичей слить в dev
